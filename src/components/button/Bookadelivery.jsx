      ...
      <div className="bg-gray-100 flex items-start justify-center px-4 py-12 min-h-[60vh]">
        <div className="w-full max-w-3xl bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="w-full mt-10">
            ...
            <div className="grid items-center gap-2" style={{ gridTemplateColumns: 'auto 1fr auto 1fr auto 1fr auto' }}>
              {/* Step 1 */}
            ...
            <div className="grid mt-2 text-xs gap-2 text-center" style={{ gridTemplateColumns: 'auto 1fr auto 1fr auto 1fr auto' }}>
