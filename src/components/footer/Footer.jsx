          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-28">
            ...
            <div className="flex flex-col sm:flex-row gap-12 sm:gap-20 lg:gap-28 flex-1">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex items-center gap-3 text-sm text-gray-300">
                  <svg className="w-4 h-4 text-[#FFA62B]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 6h16v12H4z" stroke="#FFA62B" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/><path d="M22 6l-10 7L2 6" stroke="#FFA62B" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                  help@multibag.com
                </div>
